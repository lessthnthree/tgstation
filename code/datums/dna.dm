 ...
 */
/* EffigyEdit Change - Character Preferences - Original:
...
GLOBAL_LIST_INIT(features_block_lengths, list(
		"[DNA_MUTANT_COLOR_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_ETHEREAL_COLOR_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_MUTANT_COLOR_PRIMARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_MUTANT_COLOR_SECONDARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_MUTANT_COLOR_TERTIARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_SKIN_COLOR_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_EARS_COLOR_PRIMARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_EARS_COLOR_SECONDARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_EARS_COLOR_TERTIARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_TAIL_COLOR_PRIMARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_TAIL_COLOR_SECONDARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_TAIL_COLOR_TERTIARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_SNOUT_COLOR_PRIMARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_SNOUT_COLOR_SECONDARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_SNOUT_COLOR_TERTIARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_HORNS_COLOR_PRIMARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_HORNS_COLOR_SECONDARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_HORNS_COLOR_TERTIARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_FRILLS_COLOR_PRIMARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_FRILLS_COLOR_SECONDARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_FRILLS_COLOR_TERTIARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_SPINES_COLOR_PRIMARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_SPINES_COLOR_SECONDARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_SPINES_COLOR_TERTIARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_MOTH_WINGS_COLOR_PRIMARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_MOTH_WINGS_COLOR_SECONDARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_MOTH_WINGS_COLOR_TERTIARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_MOTH_ANTENNAE_COLOR_PRIMARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_MOTH_ANTENNAE_COLOR_SECONDARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
		"[DNA_MOTH_ANTENNAE_COLOR_TERTIARY_BLOCK]" = DNA_BLOCK_SIZE_COLOR,
	))
